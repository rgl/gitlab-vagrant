...
gitlab_version="${1:-13.10.3-ce.0}"; shift || true
...
# see https://gitlab.com/gitlab-org/gitlab-foss/blob/v13.10.3/app/models/user.rb
# see https://gitlab.com/gitlab-org/gitlab-foss/blob/v13.10.3/app/models/personal_access_token.rb
# see https://gitlab.com/gitlab-org/gitlab-foss/blob/v13.10.3/app/controllers/profiles/personal_access_tokens_controller.rb
...
# see https://gitlab.com/gitlab-org/gitlab-foss/blob/v13.10.3/app/models/appearance.rb
gitlab-rails runner -e production - <<'EOF'
