...
gitlab_version="${1:-18.0.1-ce.0}"; shift || true
...
# see https://gitlab.com/gitlab-org/gitlab-foss/blob/v18.0.1/app/models/user.rb
# see https://gitlab.com/gitlab-org/gitlab-foss/blob/v18.0.1/app/models/personal_access_token.rb
...
# see https://gitlab.com/gitlab-org/gitlab-foss/blob/v18.0.1/app/models/appearance.rb
gitlab-rails runner -e production - <<'EOF'
