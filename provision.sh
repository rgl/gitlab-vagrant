...
gitlab_version="${1:-17.5.0-ce.0}"; shift || true
...
# see https://gitlab.com/gitlab-org/gitlab-foss/blob/v17.5.0/app/models/user.rb
# see https://gitlab.com/gitlab-org/gitlab-foss/blob/v17.5.0/app/models/personal_access_token.rb
...
# see https://gitlab.com/gitlab-org/gitlab-foss/blob/v17.5.0/app/models/appearance.rb
gitlab-rails runner -e production - <<'EOF'
