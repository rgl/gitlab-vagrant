...
gitlab_version="${1:-14.8.4-ce.0}"; shift || true
...
# see https://gitlab.com/gitlab-org/gitlab-foss/blob/v14.8.4/app/models/user.rb
# see https://gitlab.com/gitlab-org/gitlab-foss/blob/v14.8.4/app/models/personal_access_token.rb
# see https://gitlab.com/gitlab-org/gitlab-foss/blob/v14.8.4/app/controllers/profiles/personal_access_tokens_controller.rb
...
# see https://gitlab.com/gitlab-org/gitlab-foss/blob/v14.8.4/app/models/appearance.rb
gitlab-rails runner -e production - <<'EOF'
