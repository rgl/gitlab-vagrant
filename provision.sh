...
gitlab_version="${1:-17.9.1-ce.0}"; shift || true
...
# see https://gitlab.com/gitlab-org/gitlab-foss/blob/v17.9.1/app/models/user.rb
# see https://gitlab.com/gitlab-org/gitlab-foss/blob/v17.9.1/app/models/personal_access_token.rb
