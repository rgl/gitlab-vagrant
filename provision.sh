...
gitlab_version="${1:-13.5.4-ce.0}"; shift || true
...
# see https://gitlab.com/gitlab-org/gitlab-foss/blob/v13.5.4/app/models/user.rb
# see https://gitlab.com/gitlab-org/gitlab-foss/blob/v13.5.4/app/models/personal_access_token.rb
# see https://gitlab.com/gitlab-org/gitlab-foss/blob/v13.5.4/app/controllers/profiles/personal_access_tokens_controller.rb
...
# see https://gitlab.com/gitlab-org/gitlab-foss/blob/v13.5.4/app/models/appearance.rb
gitlab-rails console -e production <<'EOF'
