...
gitlab_version="${1:-17.4.2-ce.0}"; shift || true
...
# see https://gitlab.com/gitlab-org/gitlab-foss/blob/v17.4.2/app/models/user.rb
# see https://gitlab.com/gitlab-org/gitlab-foss/blob/v17.4.2/app/models/personal_access_token.rb
...
# see https://gitlab.com/gitlab-org/gitlab-foss/blob/v17.4.2/app/models/appearance.rb
gitlab-rails runner -e production - <<'EOF'
