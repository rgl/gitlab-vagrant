...
gitlab_version="${1:-19.1.1-ce.0}"; shift || true
...
# see https://gitlab.com/gitlab-org/gitlab-foss/blob/v19.1.1/app/models/user.rb
# see https://gitlab.com/gitlab-org/gitlab-foss/blob/v19.1.1/app/models/personal_access_token.rb
...
# see https://gitlab.com/gitlab-org/gitlab-foss/blob/v19.1.1/app/models/appearance.rb
gitlab-rails runner -e production - <<'EOF'
