...
gitlab_version="${1:-15.5.1-ce.0}"; shift || true
...
# see https://gitlab.com/gitlab-org/gitlab-foss/blob/v15.5.1/app/models/user.rb
# see https://gitlab.com/gitlab-org/gitlab-foss/blob/v15.5.1/app/models/personal_access_token.rb
# see https://gitlab.com/gitlab-org/gitlab-foss/blob/v15.5.1/app/controllers/profiles/personal_access_tokens_controller.rb
...
# see https://gitlab.com/gitlab-org/gitlab-foss/blob/v15.5.1/app/models/appearance.rb
gitlab-rails runner -e production - <<'EOF'
